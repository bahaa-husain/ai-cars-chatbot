from mock_data import MOCK_CARS, get_market_analysis
...
def get_recommendations(
    ...
    return {
        "suggested_for_you": _suggested_for_you(budget_max, preferred_brand, viewed_car_ids, limit),
        "best_deals": _best_deals(limit),
        "similar_to_viewed": _similar_to_viewed(viewed_car_ids, limit),
        "from_favorites": _from_favorites(favorite_car_ids, limit),
    }


def _suggested_for_you(budget_max, preferred_brand, exclude_ids, limit):
    results = []
